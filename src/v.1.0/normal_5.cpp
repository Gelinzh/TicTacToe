...
Normal_5::Normal_5(QWidget *parent) : GameImple(5, parent)
{
    qsrand(QTime(0, 0, 0).secsTo(QTime::currentTime()));
    switch_side = false;
}

void Normal_5::Operation()
{
...
int Normal_5::GetPriority(int next_move)
{
    ...
    if(Checkerboard[next_move % 5][next_move / 5] == 1) //switch view of side
        Checkerboard[next_move % 5][next_move / 5] = 2;
    else
        Checkerboard[next_move % 5][next_move / 5] = 1;
...
bool Normal_5::Check()
{
    ...
    if((finish == 25) && (!result)) //reach step 25 but the result have not been concluded
        result = 3;
...
int Normal_5::CheckerBoard(int Checkerboard[5][5])
{
    int result = 0;
...
void Normal_5::Again(bool isResetSide)
{
    //clean the table
    for (int i = 0; i < 25; i++)
    {
